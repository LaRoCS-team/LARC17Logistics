...
class Env1:
    ...
    def observe(self):
        ...
        if self.should_go_to_dock:
            terminal = True
            if isinstance(self.robot.current_in, Dock):
                print("Went to the dock!")
                Env1.t_reward = 15
...
if __name__ == "__main__":
    ...
    for e in range(2000000):
        ...
        env = Env1(red_machine_pos=    [304, 110],
                   blue_machine_pos=   [304, 220],
                   yellow_machine_pos= [111, 162],
                   dock_position=      [0, 0],
                   dc1_pos=            [50,  320],
                   dc2_pos=            [110, 320],
                   dc3_pos=            [170, 320],
